object DM: TDM
  ...
  object qryPessoas: TFDQuery
    ...
    Connection = conPessoas
    Transaction = tacPessoas
    UpdateTransaction = tacPessoas
  ...
  object tacPessoas: TFDTransaction
    Connection = conPessoas
    Left = 168
    Top = 32
  end
  ...
  object conPessoas: TFDConnection
    Params.Strings = (
      'ConnectionDef=PESSOAS')
    Connected = True
    LoginPrompt = False
    Left = 61
    Top = 21
